...
final class ClientShellCommandSet {
  ...
  ClientShellCommandSet(ClientReplicaApi client, PrintWriter out, PrintWriter err) {
    this.client = client;
    this.out = out;
    this.err = err;
  ...
  private final class DepCoinTransferCommand implements Runnable {
    ...
    public void run() {
      try {
        printTransactionResponse(client.transferDepCoin(recipientAddress, amount, nonce, gasLimit, gasPrice));
  ...
  private final class DepCoinBalanceCommand implements Runnable {
    ...
    public void run() {
      try {
        printQueryResponse("depcoinBalance", ownerAddress == null ? client.getOwnDepCoinBalance() : client.getDepCoinBalance(ownerAddress));
      } catch (IncoherentReplicaResponseException exception) {
  ...
  private final class IstBalanceCommand implements Runnable {
    ...
    public void run() {
      try {
        printQueryResponse("istBalance", ownerAddress == null ? client.getOwnIstCoinBalance() : client.getIstCoinBalance(ownerAddress));
      } catch (IncoherentReplicaResponseException exception) {
  ...
  private final class IstCoinTransferCommand implements Runnable {
    ...
    public void run() {
      try {
        printBooleanResponse("transferResult", client.transferIstCoin(recipientAddress, rawValue, nonce, gasLimit, gasPrice));
      } catch (IncoherentReplicaResponseException exception) {
  ...
  private final class ContractCallCommand implements Runnable {
    ...
    public void run() {
      try {
        ...
        printTransactionResponse(client.callContract(contractAddress, amount, nonce, gasLimit, gasPrice, input));
      } catch (IncoherentReplicaResponseException exception) {
