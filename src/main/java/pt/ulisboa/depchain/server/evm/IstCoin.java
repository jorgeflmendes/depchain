...
public final class IstCoin {
  ...
  public IstCoin(EvmService evmService, Address contractAddress) {
    ...
    this.contractAddress = pt.ulisboa.depchain.shared.utils.ValidationUtils.requireNonNull(contractAddress, "contractAddress");
  }
  ...
  public EvmService.TransactionResult readBalanceOf(Address owner) {
    try {
